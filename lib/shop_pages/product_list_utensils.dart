...
class ProductListUtensils extends StatefulWidget {
  const ProductListUtensils({super.key});

  @override
  State<ProductListUtensils> createState() => _ProductListUtensilsState();
}

class _ProductListUtensilsState extends State<ProductListUtensils> {
              ...
              builder: (context, constraints) {
                if (constraints.maxWidth > 1080) {
                  return GridView.builder(
                    itemCount: utensilproducts.length,
                    gridDelegate:
                    ...
                    itemBuilder: (context, index) {
                      final product = utensilproducts[index];
